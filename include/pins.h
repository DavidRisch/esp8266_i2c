...
#define PIN_REMOTE_CONTROL_LEFT_BUTTON 15
#define PIN_REMOTE_CONTROL_RIGHT_BUTTON 16
#define PIN_REMOTE_CONTROL_SPEED 17
#define PIN_REMOTE_CONTROL_LED_GREEEN 18
#define PIN_REMOTE_CONTROL_LED_RED 19
